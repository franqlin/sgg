                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <p class="red">5 nova(s) mensagens</p>
                            </li>
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="${ctxPath}/img/avatar-mini.jpg"></span>
                                    <span class="subject">
                                    <span class="from">Maria do Socorro</span>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="#"><i class="icon-bell-alt"></i>Notifica&ccedil;&amacr;o</a></li>
                            <li><a href="${pageContext.request.contextPath}/logout"><i class="icon-key"></i>Sair</a></li>
                        </ul>
                    </li>
                    <!-- login fim -->
                </ul>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-8">
                      ...
                      <section class="panel">
                          ...
                          <c:forEach items="${listGeladeira}" var="g">
                              <tr>
                                  <td>${g.id}</td>
                                  <td>
                                       ${g.descricao}
